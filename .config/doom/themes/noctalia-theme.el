...
(let* ((bg "#121318")
       ...
       (on-primary "#1d2d61")
       (on-primary-container "#121318")
       (on-secondary "#2b3042")
       (on-secondary-container "#dee1f9")
       (on-surface "#e3e1e9")
       (on-surface-variant "#c6c5d0")
       (on-tertiary "#432740")
       (on-tertiary-container "#ffd7f5")
       (outline-color "#90909a")
       (outline-variant "#45464f")
       (primary "#b6c4ff")
       (primary-container "#B6C4FF")
       (secondary "#c2c5dd")
       ...
       (success "#e3bada")
       (on-success "#432740")
       (success-container "#5b3d57")
       (on-success-container "#ffd7f5")
       ;; Map fixed colors to regular colors
       (primary-fixed "#121318")
       (primary-fixed-dim "#1E1F25")
       (secondary-fixed "#c2c5dd")
       (secondary-fixed-dim "#424659")
       (tertiary-fixed "#e3bada")
       (tertiary-fixed-dim "#5b3d57")
       (on-primary-fixed "#B6C4FF")
       (on-primary-fixed-variant "#dce1ff")
       (on-secondary-fixed "#2b3042")
       (on-secondary-fixed-variant "#dee1f9")
       (on-tertiary-fixed "#432740")
       (on-tertiary-fixed-variant "#ffd7f5")
       ;; Map inverse colors to surface variants
       (inverse-on-surface "#e3e1e9")
